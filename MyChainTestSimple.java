// No package declaration for standalone execution

import dataStructures.MyChain;
import java.util.Iterator;
import java.util.NoSuchElementException;

/**
 * Simple standalone unit tests for MyChain class
 * This version works without Maven and doesn't use lambda expressions
 */
public class MyChainTestSimple {
    ...
    public static void main(String[] args) {
        System.out.println("==========================================");
        System.out.println("MyChain Unit Tests (Simple Version)");
        System.out.println("==========================================");
        
        MyChainTestSimple test = new MyChainTestSimple();
        test.runAllTests();
    ...
    private void assertExceptionThrown(String message, Class<? extends Exception> expectedException) {
        testsRun++;
        testsPassed++;
        System.out.println("✅ " + message + " (Correctly threw " + expectedException.getSimpleName() + ")");
    }

    private void assertNoExceptionThrown(String message, Class<? extends Exception> expectedException) {
        testsRun++;
        testsFailed++;
        System.out.println("❌ " + message + " (Expected " + expectedException.getSimpleName() + " but none was thrown)");
    }
    ...
    private void testAddOperations() {
        ...
        try {
            chain.add(-1, "invalid");
            assertNoExceptionThrown("Add with negative index should throw IndexOutOfBoundsException", IndexOutOfBoundsException.class);
        } catch (IndexOutOfBoundsException e) {
            assertExceptionThrown("Add with negative index correctly throws IndexOutOfBoundsException", IndexOutOfBoundsException.class);
        }
        
        // Test invalid index - too large
        try {
            chain.add(5, "invalid");
            assertNoExceptionThrown("Add with index > size should throw IndexOutOfBoundsException", IndexOutOfBoundsException.class);
        } catch (IndexOutOfBoundsException e) {
            assertExceptionThrown("Add with index > size correctly throws IndexOutOfBoundsException", IndexOutOfBoundsException.class);
        }
    }
    ...
    private void testGetOperations() {
        ...
        try {
            chain.get(-1);
            assertNoExceptionThrown("Get with negative index should throw IndexOutOfBoundsException", IndexOutOfBoundsException.class);
        } catch (IndexOutOfBoundsException e) {
            assertExceptionThrown("Get with negative index correctly throws IndexOutOfBoundsException", IndexOutOfBoundsException.class);
        }
        
        // Test invalid index - too large
        try {
            chain.get(3);
            assertNoExceptionThrown("Get with index >= size should throw IndexOutOfBoundsException", IndexOutOfBoundsException.class);
        } catch (IndexOutOfBoundsException e) {
            assertExceptionThrown("Get with index >= size correctly throws IndexOutOfBoundsException", IndexOutOfBoundsException.class);
        }
    }
    ...
    private void testRemoveOperations() {
        ...
        try {
            chain.remove(-1);
            assertNoExceptionThrown("Remove with negative index should throw IndexOutOfBoundsException", IndexOutOfBoundsException.class);
        } catch (IndexOutOfBoundsException e) {
            assertExceptionThrown("Remove with negative index correctly throws IndexOutOfBoundsException", IndexOutOfBoundsException.class);
        }
        
        // Test invalid index - too large
        try {
            chain.remove(1);
            assertNoExceptionThrown("Remove with index >= size should throw IndexOutOfBoundsException", IndexOutOfBoundsException.class);
        } catch (IndexOutOfBoundsException e) {
            assertExceptionThrown("Remove with index >= size correctly throws IndexOutOfBoundsException", IndexOutOfBoundsException.class);
        }
    }
    ...
    private void testIteratorOperations() {
        ...
        // Test exceptions - empty chain
        try {
            chain = new MyChain();
            chain.iterator().next();
            assertNoExceptionThrown("Iterator next on empty chain should throw NoSuchElementException", NoSuchElementException.class);
        } catch (NoSuchElementException e) {
            assertExceptionThrown("Iterator next on empty chain correctly throws NoSuchElementException", NoSuchElementException.class);
        }
        
        // Test exceptions - beyond last element
        try {
            chain = new MyChain();
            chain.add(0, "only");
            Iterator singleIterator = chain.iterator();
            singleIterator.next();
            singleIterator.next();
            assertNoExceptionThrown("Iterator next beyond last element should throw NoSuchElementException", NoSuchElementException.class);
        } catch (NoSuchElementException e) {
            assertExceptionThrown("Iterator next beyond last element correctly throws NoSuchElementException", NoSuchElementException.class);
        }
        ...
        try {
            ...
            assertNoExceptionThrown("Iterator remove should throw UnsupportedOperationException", UnsupportedOperationException.class);
        } catch (UnsupportedOperationException e) {
            assertExceptionThrown("Iterator remove correctly throws UnsupportedOperationException", UnsupportedOperationException.class);
        }
    }
    ...
    private void testComplexScenarios() {
        ...
        assertEquals(8, unionResult.size(), "Complex union has correct size");
